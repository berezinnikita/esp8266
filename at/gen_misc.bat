...
if %burn% equ yes (
  ...
  rem %devkit_dir%\utils\ESP8266\esptool-ck.exe -cp COM%port% -cd ck -cb 256000 -ca 0x00000 -cf firmware/eagle.flash.bin
  rem %devkit_dir%\utils\ESP8266\esptool-ck.exe -cp COM%port% -cd ck -cb 256000 -ca 0x40000 -cf firmware/eagle.irom0text.bin 
)
